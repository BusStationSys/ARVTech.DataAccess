namespace ARVTech.DataAccess.Service.UniPayCheck
{
    ...
    public class MatriculaService : BaseService, IMatriculaService
    {
        ...
        //            this._unitOfWork))
        //        {
        //            pessoaJuridicaResponseDto = pessoaJuridicaService.GetByCnpj(
        ...
        //            pessoaFisicaResponseDto = pessoaFisicaService.GetByCpf(
        //                cpf);
        ...
        //                pessoaFisicaResponseDto = pessoaFisicaService.SaveData(
        ...
        //            usuariosResponseDto = usuarioService.GetByUsername(
        //                username);
        //        }
