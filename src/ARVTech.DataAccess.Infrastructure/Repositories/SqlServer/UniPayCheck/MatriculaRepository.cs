namespace ARVTech.DataAccess.Infrastructure.Repositories.SqlServer.UniPayCheck
{
    ...
    public class MatriculaRepository : BaseRepository, IMatriculaRepository
    {
        ...
        public Task<MatriculaEntity> GetAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public PagedResult<MatriculaEntity> GetAllPaged(int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }

        public Task<PagedResult<MatriculaEntity>> GetAllPagedAsync(int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }
