namespace ARVTech.DataAccess.Infrastructure.Repositories.SqlServer.UniPayCheck
{
    ...
    public class MatriculaEspelhoPontoCalculoRepository : BaseRepository, IMatriculaEspelhoPontoCalculoRepository
    {
        ...
        public PagedResult<MatriculaEspelhoPontoCalculoEntity> GetAllPaged(int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }

        public Task<PagedResult<MatriculaEspelhoPontoCalculoEntity>> GetAllPagedAsync(int pageNumber, int pageSize)
        {
            throw new NotImplementedException();
        }

        public Task<MatriculaEspelhoPontoCalculoEntity> GetAsync(Guid id)
        {
            throw new NotImplementedException();
        }
