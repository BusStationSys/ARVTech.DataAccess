namespace ARVTech.DataAccess.Repository.SqlServer.UniPayCheck
{
    ...
    public class MatriculaEspelhoPontoMarcacaoRepository : BaseRepository, IMatriculaEspelhoPontoMarcacaoRepository
    {
        ...
        public MatriculaEspelhoPontoMarcacaoRepository(SqlConnection connection) :
            base(connection)
        {
        ...
        public MatriculaEspelhoPontoMarcacaoRepository(SqlConnection connection, SqlTransaction transaction)
