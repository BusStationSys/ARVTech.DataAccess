namespace ARVTech.DataAccess.Repository.SqlServer.UniPayCheck
{
    ...
    public class MatriculaEspelhoPontoCalculoRepository : BaseRepository, IMatriculaEspelhoPontoCalculoRepository
    {
        ...
        public MatriculaEspelhoPontoCalculoRepository(SqlConnection connection) :
            base(connection)
        {
        ...
        public MatriculaEspelhoPontoCalculoRepository(SqlConnection connection, SqlTransaction transaction)
