...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterMatriculaDemonstrativoPagamentoPorMatricula]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorMatricula]
GO
...
CREATE PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorMatricula]
