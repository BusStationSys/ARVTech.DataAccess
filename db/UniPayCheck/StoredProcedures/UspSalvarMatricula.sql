--exec UspSalvarMatricula '{"Guid":"00000000-0000-0000-0000-000000000000","Username":"UserMain","Password":"(u53rM@1n)","DataPrimeiroAcesso":"2024-12-29T06:00:00.6234419+00:00","IdPerfilUsuario":1}'
--exec UspSalvarMatricula '{"Username": "kauana.rocha", "Password": "82216", "IdPerfilUsuario": 999999, "GuidColaborador": "73BF04D1-3B7B-44EB-B340-03E2DC2E5226"}'

If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspSalvarMatricula]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspSalvarMatricula]
GO
...
GO
 ...
 CREATE PROCEDURE [dbo].[UspSalvarMatricula]
