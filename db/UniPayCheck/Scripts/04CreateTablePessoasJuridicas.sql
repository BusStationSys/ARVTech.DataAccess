...
ALTER TABLE [dbo].[PESSOAS_JURIDICAS] DROP CONSTRAINT [FK_PESSOAS_JURIDICAS_BANDEIRAS_COMERCIAIS]
GO
...
CREATE TABLE [dbo].[PESSOAS_JURIDICAS](
	...
	[IDBANDEIRA_COMERCIAL] [int] NOT NULL,
...
ALTER TABLE [dbo].[PESSOAS_JURIDICAS]  WITH CHECK ADD  CONSTRAINT [FK_PESSOAS_JURIDICAS_BANDEIRAS_COMERCIAIS] FOREIGN KEY([IDBANDEIRA_COMERCIAL])
REFERENCES [dbo].[BANDEIRAS_COMERCIAIS] ([ID])
GO

ALTER TABLE [dbo].[PESSOAS_JURIDICAS] CHECK CONSTRAINT [FK_PESSOAS_JURIDICAS_BANDEIRAS_COMERCIAIS]
GO
