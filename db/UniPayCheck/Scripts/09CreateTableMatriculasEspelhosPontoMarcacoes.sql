...
/****** Object:  Table [dbo].[MATRICULAS_ESPELHOS_PONTO_MARCACOES]    Script Date: 22/08/2023 09:06:35 ******/
...
CREATE TABLE [dbo].[MATRICULAS_ESPELHOS_PONTO_MARCACOES](
	...
	[GUID_MATRICULAS_ESPELHO_PONTO] [uniqueidentifier] NOT NULL,
	[DATA] [date] NOT NULL,
	[MARCACAO] [varchar](max) NOT NULL,
	[HORAS_NORMAIS] [time](7) NULL,
...
ALTER TABLE [dbo].[MATRICULAS_ESPELHOS_PONTO_MARCACOES]  WITH CHECK ADD  CONSTRAINT [FK_MATRICULAS_ESPELHOS_PONTO_MARCACOES_MATRICULAS_ESPELHOS_PONTO] FOREIGN KEY([GUID_MATRICULAS_ESPELHO_PONTO])
