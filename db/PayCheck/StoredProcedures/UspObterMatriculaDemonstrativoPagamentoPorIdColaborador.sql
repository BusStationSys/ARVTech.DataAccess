...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterMatriculaDemonstrativoPagamentoPorIdColaborador]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorIdColaborador]
GO
...
CREATE PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorIdColaborador]
...
SET NOCOUNT ON
 ...
 LEFT OUTER JOIN [dbo].[TOTALIZADORES] AS T WITH(NOLOCK)
		   ...
		   WHERE M.[GUIDCOLABORADOR] = @GuidColaborador
