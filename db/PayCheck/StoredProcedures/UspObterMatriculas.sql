...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterMatriculas]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterMatriculas]
GO
...
CREATE PROCEDURE [dbo].[UspObterMatriculas]
