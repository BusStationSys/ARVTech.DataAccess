...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterPessoaJuridicaPorCnpj]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterPessoaJuridicaPorCnpj]
GO
...
GO
 ...
 CREATE PROCEDURE [dbo].[UspObterPessoaJuridicaPorCnpj]
    @Cnpj CHAR(14)
