...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterPessoaJuridicaPorId]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterPessoaJuridicaPorId]
GO
...
CREATE PROCEDURE [dbo].[UspObterPessoaJuridicaPorId]
