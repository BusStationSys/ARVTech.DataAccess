...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterMatriculaDemonstrativoPagamentoPorCompetencia]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorCompetencia]
GO
...
CREATE PROCEDURE [dbo].[UspObterMatriculaDemonstrativoPagamentoPorCompetencia]
