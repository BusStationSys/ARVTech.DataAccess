...
If Exists(Select * From sysobjects Where ID = OBJECT_ID(N'[dbo].[UspObterPessoaFisicaPorCpf]') And OBJECTPROPERTY(ID, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[UspObterPessoaFisicaPorCpf]
GO
...
CREATE PROCEDURE [dbo].[UspObterPessoaFisicaPorCpf]
	@Cpf AS CHAR(11)
